	.data
array: .word 0:4 #Declare the array of 5 integer numbers
size: .word 5 #Declare size of array = 5
...
saveArray:
	...
	addi	$a2, $a2, 16 # increase address 4*4 = 16 unit to start at end of array
